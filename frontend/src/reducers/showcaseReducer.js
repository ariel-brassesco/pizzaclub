...
export const getProductsUpdate = state => state.showcase.productsStatus.update;
export const getProductsLastModified = state => state.showcase.prodcutsStatus.last_modified;
...
export const getTypesLastModified = state => state.showcase.typesStatus.last_modified;